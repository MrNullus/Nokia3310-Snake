document.addEventListener('DOMContentLoaded', () => {
    ...
    function startGame() {
        ...
        interval = setInterval(mouveOutcomes, intervalTime);
    }

    // function that deals with ALL the ove outcomes of the Snake
    function mouveOutcomes() {
    ...
    function randomApple() {
        ...
        // making were apples dont appear on the snake
    ...
    function control(e) {
        ...
        if (e.keyCode === 39) {
            ...
            // if we press the uo arrow, the snake  will go back ten divs, appearing to go up
            direction = -width;
        } else if (e.keyCode === 37) {
            // if we press left, the snake will go left ine div
            direction = -1;
